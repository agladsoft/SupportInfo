        ...
        <div class="service-section">
            ...
            <div class="info-card inn-card">
                ...
                <div class="inn-description">
                    <div>Запрос считает, сколько записей в таблице относятся к компаниям, у которых:</div>
                    <ul class="inn-criteria">
                        ...
                        <li>и при этом оба поля — company_inn и company_name_unified — заполнены</li>
                    </ul>
                </div>
            </div>
        </div>
